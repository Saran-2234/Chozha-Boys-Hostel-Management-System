...
const ProfileDropdown = ({ onLogoutClick, studentData, setActiveSection }) => {
  ...
  return (
    <div className="relative" style={{ zIndex: 40, position: 'relative' }}>
      <button onClick={toggleDropdown} className="flex items-center space-x-3 glass-effect px-4 py-2 rounded-lg hover:bg-gray-200 transition-all">
      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-48 glass-card rounded-lg shadow-lg z-10 bg-white">
          <div className="py-2">
            <button
